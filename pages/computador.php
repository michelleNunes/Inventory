...
<?php
	...
	if($action = 'delete'){
        echo "<script> 'if(confirm('Confirm Delete?')==true){'"
        $id = &$_GET['id'];
        $sqltxt = sqlsrv_query($connection,"DELETE FROM Inventory.dbo.computador WHERE id='$id'");
        echo "</script>";
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.php">
                    <img src="http://www.apassos.com.br/wp-content/themes/apassos/res/images/logo.png" alt="">
                </a>
            </div>
...
<form name="formpesq" method="post" action="?action=search">
    <div class="col-md-4">
        ...
        <div class="col-sm-4 text-left h2">
            <a class="btn btn-default" href="cadastro/cadastro_computador.php" style="border-color: #0D47A1"><i class="fa fa-plus"></i>
    ...
    <table class="table table-sm table-hover">
        ...
        <tr>
            ...
            <?php
                ...
                $sql = sqlsrv_query($connection,"SELECT computador.* FROM Inventory.dbo.computador WHERE hostname LIKE '%".$strKeyword."%'");

                while($vetor = sqlsrv_fetch_array($sql,SQLSRV_FETCH_ASSOC)){
                ?>
                    <tr>
                                                <td  onclick="window.location.href='visualizar/visualizar_comp.php?id=<?php echo $vetor['id']; ?>'">
                        ...
                        <th>
                            ...
                            <a href="update/update_computador.php?id=<?php echo $vetor['id']; ?>" >
   ...
   <footer class="footer">
    ...
    <script>
        $("click").change(function(){
            document.location.href = $('visualizar/visualizar_comp.php?id=<?php echo $vetor['id']; ?>').value();
        });
    </script>
