...
<?php
    ...
    if($action = 'delete'){
        $id = &$_GET['id'];
        $sqltxt = sqlsrv_query($connection,"DELETE FROM Inventory.dbo.software WHERE id='$id'");
        $sqltxt2 = sqlsrv_query($connection,"DELETE FROM Inventory.dbo.licenca WHERE software_id='$id'");
...
<form name="formpesq" method="post" action="?action=search">
    <div class="col-md-4">
        ...
        <div class="col-md-4 text-left h2">
            <a class="btn btn-default" href="cadastro/cadastro_software.php" style="border-color: #0D47A1"><i class="fa fa-plus"></i>
    ...
    <table class="table table-sm table-hover">
        ...
        <tr>
    		...
    		<tbody>
            <?php
                $sql = sqlsrv_query($connection,"SELECT software.* FROM Inventory.dbo.software WHERE descricao LIKE '%".$strKeyword."%'");
                ...
                ?>
                    <tr>
                        ...
                        <td onclick="window.location.href='visualizar/visualizar_soft.php?id=<?php echo $vetor['id']; ?>'"><?php echo $vetor['descricao'];?></td>
                        <td onclick="window.location.href='visualizar/visualizar_soft.php?id=<?php echo $vetor['id']; ?>'"><?php echo $vetor['preco'];?></td>
                        <td onclick="window.location.href='visualizar/visualizar_soft.php?id=<?php echo $vetor['id']; ?>'"><?php echo $vetor['quant_licenca'];?></td>
                        <td onclick="window.location.href='visualizar/visualizar_soft.php?id=<?php echo $vetor['id']; ?>'"><?php echo $vetor['dataaquisicao']->format('d/m/Y');?></td>
                       
                        <th>
                             
                            <button type="button" class="btn btn-default" style="border-color:#FF7043">
                            <a href="update/update_software.php?id=<?php echo $vetor['id']; ?>" >
                           ...
                           <button type="button" class="btn btn-default" style="border-color:#F44336">
                            <a href="?action=delete&id=<?php echo $vetor['id']; ?>">
                            <font color="#F44336" >
   ...
   <footer class="footer">
    ...
    <script>
        $("click").change(function(){
            document.location.href = $('visualizar/visualizar_soft.php?id=<?php echo $vetor['id']; ?>').value();
        });
    </script>
</body>
