...
$sqltxt= "select software.* from Inventory.dbo.software
...
<dl class="dl-horizontal">
	...
	<dt>Licences Number:</dt>
	<dd><?php echo $vetor['quant_licenca'];?></dd>

	<dt>Acquired Date :</dt>
	<dd><?php echo $vetor['dataaquisicao']->format('d/m/Y');?>
...
<dl class="dl-horizontal">
    <dt>Employeers:</dt>
	<?php $sql2 = sqlsrv_query($connection,"select * from Inventory.dbo.licenca where software_id='$id'");?>
    <?php while($vetor = sqlsrv_fetch_array($sql2,SQLSRV_FETCH_ASSOC)){?>
        <dd><?php echo $vetor['funcionario'];?></br></dd>
...
<div id="actions" class="row-right">
	...
	<button type="submit" class="btn btn-default" style="border-color:#FF7043">
        <a href="../update/update_software.php" >
	...
	<button type="button" class="btn btn-default" style="border-color:#F44336">
	  <a href="../software.php"><font color="#F44336">
