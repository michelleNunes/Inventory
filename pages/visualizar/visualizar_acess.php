...
$sqltxt= "select acessorios.* from Inventory.dbo.acessorios where descricao = '$descricao' and modelo='$modelo'";
...
<div id="actions" class="row-right">
	...
	<button type="submit" class="btn btn-default" style="border-color:#FF7043">
        <a href="../update/update_acessorio.php" >
	...
	<button type="button" class="btn btn-default" style="border-color:#F44336">
	  <a href="../acessorios.php"><font color="#F44336">
